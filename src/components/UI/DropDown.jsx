...
const Dropdown = ({ title, icon, arrowIcon, imageSrc, text }) => {
  ...
  return (
    <div className=" w-[91.47vw] h-auto max-w-lg mx-auto border border-[#86868B33] rounded-lg bg-[#050C0C] text-white shadow-md">
      ...
      >
        ...
        <div className="flex items-center space-x-2 min-h-[81px] w-[81.63vw]">
          <img src={icon} alt="Icon" className="w-8 h-8" />
          <span className="font-roboto font-bold break-words w-[61.87vw] text-left text-[20px] leading-[27px] tracking-[2%] uppercase">
            {title}
          </span>
        </div>
        ...
        <img
          ...
          alt="Arrow"
          className={`w-[23px] h-[20px] transition-transform duration-300 ${isOpen ? "rotate-180" : "rotate-90"
            }`}
        />
      </button>
