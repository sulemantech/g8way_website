...
function Home({ scrollToSection, refs }) {
    ...
    return (
        <div ref={homeRef} className="relative overflow-hidden  font-roboto min-h-[850px] max-md:min-h-[1015px]">

            <TextAnimation />

            <div className='absolute lg:right-[125px]  max-lg:right-2 max-lg:scale-75 max-lg:top-56 lg:top-[25px] w-[413px] h-[332px] z-40 max-md:top-[50%] max-md:hidden'>
            ...
            <div className="absolute bottom-0 left-[140px] max-sm:-left-32 max-sm:scale-[0.8] max-sm:top-[220px] max-md:left-0 max-md:!right-0 max-sm:right-28 max-lg:bottom-32 max-md:bottom-[39%] z-0">
                <img
