...
function About() {
    return (
        <div className='bg-black py-12'>
            <div className='w-[1296px] h-[514px]  mx-auto flex flex-col justify-between py-[80px] mb-14 max-[1300px]:h-auto max-[1300px]:w-full'>
                <p className="font-roboto text-white h-[46px] font-bold text-[46px] leading-[46px] tracking-[2%] text-center uppercase"
            ...
            <div className='py-24 px-[72px] flex justify-between items-end max-lg:flex-col max-lg:space-y-4 max-lg:items-center'>
                <img className='w-[616px] h-[459px] max-xl:scale-90 max-lg:scale-100' src="aboutaeroplane.png" alt="" />
                <div className=' flex flex-col space-y-3 items-start ml-3 justify-between w-[521px] max-xl:scale-90 max-lg:scale-100'>
            ...
            <div className='py-20 px-[72px] flex justify-between items-end max-lg:flex-col max-lg:space-y-4 max-lg:items-center'>
                ...
                <img className='w-[616px] h-[459px] rounded-2xl max-xl:scale-90 max-lg:scale-100' src="aboutMuseum.png" alt="" />
            </div>
