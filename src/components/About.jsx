...
function About() {
    return (
        <div className='bg-[#050C0C] py-12'>
            <div className='w-[1296px] h-[514px]  mx-auto flex flex-col justify-between py-[80px] mb-14 max-[1300px]:h-auto max-[1300px]:w-full'>
                <p className="font-roboto text-white h-[46px] font-bold text-[46px] leading-[46px] tracking-[2%] text-center uppercase max-md:text-[32px] max-md:leading-[34px] max-md:my-4"
