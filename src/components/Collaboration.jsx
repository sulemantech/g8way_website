        ...
        <>
            <div>
                <div className='flex flex-col space-y-3 h-[592px] font-roboto items-center justify-center relative'>
                    ...
                    <p className={`font-normal opacity-90 mb-7 text-[#f0f0f0] text-[18px] leading-[26px]  max-md:text-[16px] max-md:leading-[24px] tracking-[0] text-center w-[843px] max-lg:max-w-[100vw]`}>
            ...
            <div className='h-[844px] font-roboto flex items-center justify-center space-x-8 bg-[#050C0C] max-md:flex-col max-md:h-auto'>
                <div className='w-[632px] h-[684px] max-[1300px]:w-[45vw] relative flex flex-col space-y-3 items-center justify-center rounded-2xl border border-[#86868B33] bg-linear-to-b from-[#FFFFFF0D] to-[#FFFFFF00] max-md:w-[91.47%]'>
                    ...
                    <p className={`font-normal w-[552px] max-lg:max-w-[100%] max-lg:scale-95 text-left opacity-90 mb-7 text-[#f0f0f0] text-[18px] leading-[26px] tracking-[0] max-[1300px]:scale-75`}>
