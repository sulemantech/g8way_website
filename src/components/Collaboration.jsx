        ...
        <>
            <div>
                <div className='flex flex-col space-y-3 h-[592px] font-roboto items-center justify-center relative'>
                    ...
                    <p className={`font-normal opacity-90 mb-5 text-white text-[18px] leading-[26px] tracking-[0] text-center w-[843px]`}>
                    ...
                    <div className='w-[632px]'>
                        ...
                        <button className='w-full h-[48px] rounded-full text-center bg-[#10E0D7] font-bold'>Submit</button>
                        <p className='opacity-80 mt-2 text-[#f0f0f0] text-[12px] font-roboto font-normal leading-[16px] text-center'>By submitting this form, you agree to receive updates and marketing communications from G8WAY. To learn more about how we handle and protect your personal data, please review our <span className='underline'>Privacy Policy</span>.</p>
            ...
            <div className='h-[844px] font-roboto flex items-center justify-center space-x-6 bg-black'>
                ...
                <div className='w-[632px] h-[684px] rounded-2xl border border-[#86868B33] bg-linear-to-b from-[#FFFFFF0D] to-[#FFFFFF00]'>
                    <img className='ml-16 mt-5' src="g8mobileinhand.png" alt="" />
                </div>
            </div>
        </>
    )
