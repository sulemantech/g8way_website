        ...
        <div className="min-h-screen bg-black text-white font-roboto">
            ...
            <div className="container mx-auto p-6">
                <div className="space-y-6">
                    {/* Table of Contents */}
                    <p>
                        The use of this website g8way-app.com may involve the processing of
                    ...
                    <p>
                        ...
                        <br />
                        GIGA FIBER Development GmbH <br />
...
"
                    ...
                    <TitleSection
                        title="4. Technical Service Providers"
...
"
                    ...
                    <TitleSection
                        title="5. Processing of Server Log Files"
                        description="<p>
...
"
                    ...
                    <TitleSection
                        title="9. Integrated Third-Party Services and Content"
...
`} />
                    <TitleSectionDec
                        title="9.3 GOOGLE WEB FONTS (LOCAL HOSTING)"
                        description={`<p>
...
<p>
  ...
  <a href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener noreferrer">Google’s Privacy Policy</a>.
                    ...
                    <TitleSectionDec
                        title="9.4 FONT AWESOME (LOCAL HOSTING)"
                        description={`<p>
...
<h4>9.9 FACEBOOK AND INSTAGRAM</h4>
<p>
...
<p>When you visit our Twitch profile, Twitch collects usage data. Twitch is solely responsible for this data processing. Twitch provides information about this in its privacy policy at <a href="https://www.twitch.tv/p/de-de/legal/privacy-notice/" target="_blank">this link</a> and in its cookie policy at <a href="https://www.twitch.tv/p/de-de/legal/cookie-notice/" target="_blank">this link</a>.</p>`} />
                    <TitleSectionDec
                        title="9.12 LINKEDIN
"
                        description={`<p>We maintain a company profile on the LinkedIn portal, an offering of LinkedIn Ireland Unlimited Company, Wilton Place, Dublin 2, Ireland.</p>

<p>When you visit our LinkedIn profile, personal data may be processed by LinkedIn. We have no influence on this data processing. The purpose and scope of the data processing by LinkedIn, as well as the related rights and setting options for protecting the privacy of users, can be found in LinkedIn’s data protection declaration at <a href="https://www.linkedin.com/legal/privacy-policy?_l=de_DE" target="_blank">this link</a>.</p>`} />
                    <TitleSectionDec
                        title="9.13 YOUTUBE
"
                        description={`<p>We operate a channel on the YouTube platform, which is provided by Google Ireland Limited, Gordon House, Barrow Street Dublin 4, Ireland.</p>

<p>Users can subscribe to our channel, mark our videos as “like” or “dislike”, share our videos or comment on them. In doing so, we process profile data and the respective interaction.</p>

<p>In addition, personal data is processed by Google when you visit our channel. We have no influence on this data processing. It is carried out in accordance with Google’s data protection declaration, which also applies to YouTube. You can find Google’s data protection declaration at: <a href="https://policies.google.com/privacy?hl=de" target="_blank">this link</a>.</p>`} />
                    <TitleSection
                        title="5. Your rights
"
                        description={`<div>
    <h2>Your Rights Under GDPR</h2>
    <p>As a person affected by data processing, you have the following rights – in each case under the legal requirements and to the extent permitted by law:</p>
    <ul>
        <li>You have the right to <strong>obtain information</strong> about the processing of your personal data (<a href="https://gdpr-info.eu/art-15-gdpr/" target="_blank">Art. 15 GDPR</a>).</li>
        <li>You have the right to <strong>obtain without undue delay the rectification</strong> of inaccurate personal data concerning you and/or the completion of incomplete personal data (<a href="https://gdpr-info.eu/art-16-gdpr/" target="_blank">Art. 16 GDPR</a>).</li>
        <li>You have the right to <strong>obtain the erasure</strong> of personal data concerning you without undue delay (<a href="https://gdpr-info.eu/art-17-gdpr/" target="_blank">Art. 17 GDPR</a>).</li>
        <li>You have the right to <strong>request the restriction</strong> of data processing concerning you (<a href="https://gdpr-info.eu/art-18-gdpr/" target="_blank">Art. 18 GDPR</a>).</li>
        <li>You have the right to <strong>receive your personal data</strong>, which you have provided, in a structured, machine-readable format and to transmit those data to another controller (<a href="https://gdpr-info.eu/art-20-gdpr/" target="_blank">Art. 20 GDPR</a>).</li>
        <li>You have the right to <strong>object to data processing</strong> on grounds relating to your particular situation, provided that the processing is based on a legitimate interest. If your data is used for direct marketing purposes, you have the right to object at any time (<a href="https://gdpr-info.eu/art-21-gdpr/" target="_blank">Art. 21 GDPR</a>).</li>
        <li>You have the right to <strong>withdraw your consent</strong> to data processing at any time without affecting the lawfulness of data processing based on consent before its withdrawal (<a href="https://gdpr-info.eu/art-7-gdpr/" target="_blank">Art. 7 (3) GDPR</a>).</li>
        <li>You have the right to <strong>complain to a supervisory authority</strong> about the processing of your data (<a href="https://gdpr-info.eu/art-77-gdpr/" target="_blank">Art. 77 GDPR</a>).</li>
    </ul>
</div>
`} />
                    <TitleSection
