...
function OurMission() {
    return (
        <div className='bg-[#10E0D7] font-roboto flex justify-between items-center space-x-[32px] uppercase min-h-[453px] px-8'>
            ...
            <div>
                ...
                <div className='w-[411px] h-[134px] bg-black rounded-2xl text-white flex flex-col space-y-1 justify-center px-2'>
                    <p className='font-normal text-[18px] leading-[26px] tracking-normal'>Say “hello” to seamless adventures. Get ready to fly smarter and live bolder!</p>
