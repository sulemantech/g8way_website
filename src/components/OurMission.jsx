...
function OurMission() {
    return (
        <div className='bg-[#10E0D7] font-roboto flex justify-between items-center space-x-[32px] min-h-[453px] px-8'>
            ...
            <div className='flex flex-col space-y-3 w-[411px] h-[287px]'>
                ...
                <div className='w-[411px] h-[134px] bg-black rounded-2xl text-white flex flex-col space-y-1 justify-center p-[24px] mt-3'>
