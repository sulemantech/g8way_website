...
function LottieAnimationComponent() {
    ...
    return (
        <div className='h-[619px] bg-[#050C0C] flex justify-between items-end max-lg:flex-col max-lg:space-y-4 max-lg:items-center w-full px-[72px] font-roboto py-20 max-md:py-6 max-lg:h-full max-lg:px-0'>
